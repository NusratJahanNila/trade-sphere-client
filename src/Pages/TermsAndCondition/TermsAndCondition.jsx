    ...
    <section className="py-12 md:py-16 mt-10 bg-base-200 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-2">
            Terms & <span className="text-[#f04a00]">Conditions</span>
          </h1>
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-2">
