...
const StatCard = ({ title, value, icon }) => (
  <div className="p-6 rounded-xl border shadow bg-white dark:bg-gray-800 flex items-center gap-4 hover:shadow-md transition-shadow duration-300">
...
const ChartCard = ({ title, children }) => (
  <div className="p-6 rounded-xl border shadow bg-white dark:bg-gray-800">
...
const QuickActionButton = ({ label, link }) => (
  <a
    href={link}
    className="px-5 py-3 rounded-lg bg-gradient-to-r from-[#f04a00] to-[#e34234] text-white font-semibold hover:shadow-lg hover:scale-[1.02] transition-all duration-200"
  >
    {label}
  </a>
);