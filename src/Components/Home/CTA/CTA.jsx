...
const CTA = () => {
  return (
    <section className="py-12 md:py-16 lg:py-20 relative overflow-hidden">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#f04a00]/10 via-orange-50/30 to-transparent dark:from-[#f04a00]/5 dark:via-gray-900/50"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 rounded-3xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/auth/register"
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#f04a00] to-orange-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:-translate-y-0.5 text-sm sm:text-base"
                >
                  Get Started Free
            ...
            {/* Right Visual */}
            <div className="bg-gradient-to-br from-[#f04a00]/5 to-orange-400/10 dark:from-gray-800 dark:to-gray-900 p-8 sm:p-10 lg:p-12 flex items-center justify-center">
              <div className="relative w-full max-w-md">
                ...
                <div className="relative z-10 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700">
